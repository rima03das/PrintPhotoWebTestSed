...
import in.pulseinfotech.printphoto.services.communication.template.OrderPendingTemplate;

import java.util.ArrayList;

public class TestOrderPendingTemplateMail {
	...
	void testOrderConf() {
		...
		OrderPendingTemplate oct = new OrderPendingTemplate();
